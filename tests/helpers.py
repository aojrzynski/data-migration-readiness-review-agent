...
from data_migration_readiness_review_agent.artifacts import ORDERED_ARTIFACT_FILE_NAMES
from data_migration_readiness_review_agent.cli import main

EXPECTED_ARTIFACT_FILES = set(ORDERED_ARTIFACT_FILE_NAMES)
EXPECTED_ARTIFACT_FILE_ORDER = list(ORDERED_ARTIFACT_FILE_NAMES)
